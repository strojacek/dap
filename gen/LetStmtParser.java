...
public class LetStmtParser extends Parser {
	...
	public static final int
		RULE_let_main = 0, RULE_let_stmt = 1, RULE_expression = 2, RULE_expressionList = 3, 
		RULE_of_var_list = 4, RULE_identifiers_list = 5, RULE_in_var_list = 6, 
		RULE_colonInts = 7, RULE_literal = 8, RULE_variables = 9;
	private static String[] makeRuleNames() {
		return new String[] {
			"let_main", "let_stmt", "expression", "expressionList", "of_var_list", 
	...
	public static class Let_stmtContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LetStmtListener ) ((LetStmtListener)listener).enterLet_stmt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LetStmtListener ) ((LetStmtListener)listener).exitLet_stmt(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LetStmtVisitor ) return ((LetStmtVisitor<? extends T>)visitor).visitLet_stmt(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Let_stmtContext let_stmt() throws RecognitionException {
		...
		enterRule(_localctx, 2, RULE_let_stmt);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(28);
