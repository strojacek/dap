...
public class FilenameStmtParser extends Parser {
	...
	public static final int
		...
		FILENAME=231;
	public static final int
		RULE_filename_main = 0, RULE_filename_stmt = 1, RULE_expression = 2, RULE_expressionList = 3, 
		RULE_of_var_list = 4, RULE_identifiers_list = 5, RULE_in_var_list = 6, 
		RULE_colonInts = 7, RULE_literal = 8, RULE_variables = 9;
	private static String[] makeRuleNames() {
		return new String[] {
			"filename_main", "filename_stmt", "expression", "expressionList", "of_var_list", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"WS", "COMMENT", "LINE_COMMENT", "FILENAME"
		};
	}
