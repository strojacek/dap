...
public class SQLProcParser extends Parser {
	...
	public static final int
		RULE_sql_main = 0, RULE_sql_proc = 1, RULE_expression = 2, RULE_expressionList = 3, 
		RULE_of_var_list = 4, RULE_identifiers_list = 5, RULE_in_var_list = 6, 
		RULE_colonInts = 7, RULE_literal = 8, RULE_variables = 9;
	private static String[] makeRuleNames() {
		return new String[] {
			"sql_main", "sql_proc", "expression", "expressionList", "of_var_list", 
	...
	public static class Sql_mainContext extends ParserRuleContext {
		...
		public List<Sql_procContext> sql_proc() {
			return getRuleContexts(Sql_procContext.class);
		}
		public Sql_procContext sql_proc(int i) {
			return getRuleContext(Sql_procContext.class,i);
		}
	...
	public static class Sql_procContext extends ParserRuleContext {
		public TerminalNode BY() { return getToken(SQLProcParser.BY, 0); }
		public VariablesContext variables() {
			return getRuleContext(VariablesContext.class,0);
		}
		public TerminalNode EXACT() { return getToken(SQLProcParser.EXACT, 0); }
		public TerminalNode TABLES() { return getToken(SQLProcParser.TABLES, 0); }
		public TerminalNode TEST() { return getToken(SQLProcParser.TEST, 0); }
		public TerminalNode WEIGHT() { return getToken(SQLProcParser.WEIGHT, 0); }
		public Sql_procContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_sql_proc; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SQLProcListener ) ((SQLProcListener)listener).enterSql_proc(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SQLProcListener ) ((SQLProcListener)listener).exitSql_proc(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SQLProcVisitor ) return ((SQLProcVisitor<? extends T>)visitor).visitSql_proc(this);
			else return visitor.visitChildren(this);
		}
	}

	public final Sql_procContext sql_proc() throws RecognitionException {
		Sql_procContext _localctx = new Sql_procContext(_ctx, getState());
		enterRule(_localctx, 2, RULE_sql_proc);
		try {
			setState(48);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
