...
class InvalidNumericalFormatException : public InterpreterBaseException {
public:
    InvalidNumericalFormatException(const std::string& message, antlr4::ParserRuleContext* context)
