...
{\raggedright {\huge \bfseries Dap 3.5}}
\vskip 4pt \hrule height 4pt width \hsize \vskip 4pt
\rightline{Data analysis \& presentation}

\vskip 0pt plus 1filll
\leftline{\Large \bfseries Susan Bassein, Ph.D.}%
...
\index[in]{SBS syntax@SBS syntax}%
...
\index[in]{title (SBS statement)@title (SBS statement)}%
...
\index[in]{datasets (SBS proc)@datasets (SBS proc)}%
...
\index[in]{sort@sort}%
\index[in]{sort (SBS proc)@sort (SBS proc)}%
...
\index[in]{print (SBS proc)@print (SBS proc)}%
...
\index[in]{tabulate (SBS proc)@tabulate (SBS proc)}%
...
\index[in]{rank@rank}%
\index[in]{rank (SBS proc)@rank (SBS proc)}%
...
\index[in]{surveyselect (SBS proc)@surveyselect (SBS proc)}%
...
\index[in]{means (SBS proc)@means (SBS proc)}%
...
\index[in]{univariate (SBS proc)@univariate (SBS proc)}%
...
\index[in]{corr (SBS proc)@corr (SBS proc)}%
...
\index[in]{glm (SBS proc)@glm (SBS proc)}%
...
\index[in]{freq (SBS proc)@freq (SBS proc)}%
\index[in]{freq@freq}%
...
\index[in]{reg (SBS proc)@reg (SBS proc)}%
...
\index[in]{logistic (SBS proc)@logistic (SBS proc)}%
\index[in]{logistic regression@logistic regression}%
...
\index[in]{npar1way (SBS proc)@npar1way (SBS proc)}%
...
\index[in]{chart (SBS proc)@chart (SBS proc)}%
...
\index[in]{plot (SBS proc)@plot (SBS proc)}%
\index[in]{plot@plot}%
...
\index[in]{SBS syntax@SBS syntax}%
\index[in]{dap (SBS proc)@dap (SBS proc)}%
...
\index[in]{data step (SBS)@data step (SBS)}%
