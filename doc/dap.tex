...
{\raggedright {\huge \bfseries Dap 3.10}}
\vskip 4pt \hrule height 4pt width \hsize \vskip 4pt
\rightline{Data Analysis \& Presentation}

\vskip 0pt plus 1filll
\leftline{\Large \bfseries Dap Authors}%
...
except that this permission notice may be stated in a t`ranslation approved
...
\textbf{dap [-k] [-d] \Texinfocommandstyletextvar{file1}.sas [ \Texinfocommandstyletextvar{file2}.c ... ]}
\textbf{dap [--keep] [--debug] \Texinfocommandstyletextvar{file1}.sas [ \Texinfocommandstyletextvar{file2}.c ... ]}
\end{Texinfopreformatted}
\end{Texinfoindented}
...
\emph{Run \texttt{dap} on the files \texttt{tweedle.sas} and \texttt{dee.c}:}
\begin{Texinfoindented}
\begin{Texinfopreformatted}%
\ttfamily dap tweedle.sas dee.c
\end{Texinfopreformatted}
\end{Texinfoindented}
