...
import com.jazz.JazzParser.NegateExpressionContext;
import org.antlr.v4.runtime.ParserRuleContext;
import com.jazz.core.IOFormatter;
import com.jazz.core.guard.ValueTypeSafeguard;
 ...
 */
public class JazzValue {

    /// False value constant
    public static final JazzValue FalseValue = new JazzValue(0);
    /// False value constant
    public static final JazzValue TrueValue = new JazzValue(1);
    /// null value constant
    public static final JazzValue NullValue = new JazzValue((Object)null);
     ...
     */
    private JazzValue(Object value) {
        this.value = value;
    }

    public JazzValue(JazzValue[] values) {
        this.value = values;
    }
     ...
     */
    public JazzValue add(JazzValue right, ParserRuleContext context) {
        if (this.isAStringValue() && right.isAStringValue()) {
            return new JazzValue(this.underlyingString() + right.underlyingString());
        }
        else if (this.isAStringValue() && right.isANumericalValue()) {
            return new JazzValue(this.underlyingString() + IOFormatter.numericalOutputFormat.format(right.underlyingNumber()));
        }
        else if (this.isANumericalValue() && right.isAStringValue()) {
            return new JazzValue(IOFormatter.numericalOutputFormat.format(this.underlyingNumber()) + right.underlyingString());
        }
        else {
     ...
     */
    public JazzValue and(JazzValue right, ParserRuleContext context) {
     ...
     */
    private JazzValue arithmeticEvaluation(JazzValue right, BiFunction<Double, Double, Double> operator, ParserRuleContext context) {
        ...
        return new JazzValue(operator.apply(this.underlyingNumber(), right.underlyingNumber()));
    }
     ...
     */
    public JazzValue divide(JazzValue right, ParserRuleContext context) {
     ...
     */
    public JazzValue equal(JazzValue right, ParserRuleContext context) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof JazzValue)) {
            return false;
        }

        JazzValue otherValue = (JazzValue) obj;
     ...
     */
    public JazzValue greaterThen(JazzValue right, ParserRuleContext context) {
     ...
     */
    public JazzValue greaterThenEqual(JazzValue right, ParserRuleContext context) {
        return this.compare(right, (l, r) -> l >= r, context);
    }
    ...
    public boolean isAnOneDimensionalArrayValue() {
        return this.value instanceof JazzValue[];
    }
     ...
     */
    public JazzValue lessThen(JazzValue right, ParserRuleContext context) {
        return this.compare(right, (l, r) -> l < r, context);
    }
     ...
     */
    public JazzValue lessThenEqual(JazzValue right, ParserRuleContext context) {
        return this.compare(right, (l, r) -> l <= r, context);
    }
     ...
     * @return This Value object instance divided by the divisor 'right'
     */
    public JazzValue modulo(JazzValue right, ParserRuleContext context) {
        return this.arithmeticEvaluation(right, (l, r) -> l % r, context);
    }
     ...
     */
    public JazzValue multiply(JazzValue right, ParserRuleContext context) {
        return this.arithmeticEvaluation(right, (l, r) -> l * r, context);
    }
     ...
     */
    public JazzValue notEqual(JazzValue right, ParserRuleContext context) {
        JazzValue eq = this.equal(right, context);
     ...
     */
    private JazzValue compare(JazzValue right, BiFunction<Double, Double, Boolean> comparison, ParserRuleContext context) {
     ...
     */
    public JazzValue negate(NegateExpressionContext context) {
        ValueTypeSafeguard.guaranteeValueIsNumerical("Only numerical values can be negated", this, context);
        return new JazzValue(-this.underlyingNumber());
    }
     ...
     */
    public JazzValue not(ParserRuleContext context) {
     ...
     */
    public JazzValue or(JazzValue right, ParserRuleContext context) {
        return this.isTruthy(context) || right.isTruthy(context) ? TrueValue : FalseValue;
    }
        ...
        if (this.isANumericalValue()) {
            ...
            if (this.isAnOneDimensionalArrayValue()){
                ...
                for (int i = 0; i < this.underlyingTwoDimensionalArray().length; i++) {
                    new JazzValue(this.underlyingTwoDimensionalArray()[i]).printValue(printStream, false);
                    if (i > 0) {
                        outputBuilder = new StringBuilder(outputBuilder.toString().concat(", "));
                    }
                }
                ...
                for (int i = 0; i < this.underlyingThreeDimensionalArray().length; i++) {
                    ...
                    new JazzValue(this.underlyingThreeDimensionalArray()[i]).printValue(printStream, false);
                }
            }
             outputBuilder = new StringBuilder(outputBuilder.toString().concat("} "));
        }
     ...
     */
    public JazzValue subtract(JazzValue right, ParserRuleContext context) {
        return this.arithmeticEvaluation(right, (l, r) -> l - r, context);
    }
     ...
     */
    public JazzValue[] underlyingOneDimensionalArray() {
        return (JazzValue[]) this.value;
    }
     ...
     */
    public JazzValue[][] underlyingTwoDimensionalArray() {
        return (JazzValue[][]) this.value;
    }
     ...
     */
    public JazzValue[][][] underlyingThreeDimensionalArray() {
        return (JazzValue[][][]) this.value;
    }
