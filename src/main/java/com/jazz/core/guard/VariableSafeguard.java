...
import org.jazz.error.variable.UndefinedVariableException;
...
public class VariableSafeguard {
     ...
     */
    public static void guaranteeVariableIsDefined(JazzValue variableValue, String variableName, ParserRuleContext context)
     ...
     */
    public static void guaranteeVariableSuffixIsNotViolated(JazzValue assignedValue, JazzParser.VariableSuffixContext context)
