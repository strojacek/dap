...
import org.jazz.error.functions.FunctionArityException;
...
public class FunctionSafeguard {
     ...
     */
    public static void guaranteeArityIsNotViolated(String functionName, JazzParser.FunctionCallArgsContext context,
