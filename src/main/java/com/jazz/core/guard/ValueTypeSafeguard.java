...
import org.jazz.error.type.TypeException;
...
public class ValueTypeSafeguard {
     ...
     */
    public static void guaranteeValueIsArray(String message, JazzValue value, ParserRuleContext context) throws TypeException {
     ...
     * @param context The parsing context where the value was used
     */
    public static void guaranteeValueIsNumerical(String message, JazzValue value, ParserRuleContext context) throws TypeException {
     ...
     * @param context The parsing context where the value was used
     */
    public static void guaranteeValueIsString(String message, JazzValue value, ParserRuleContext context) throws TypeException {
