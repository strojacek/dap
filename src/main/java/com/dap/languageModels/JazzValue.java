...
package com.dap.languageModels;

import com.dap.DapParser.NegateExpressionContext;
import org.antlr.v4.runtime.ParserRuleContext;
import com.dap.core.IOFormatter;
import com.dap.core.guard.ValueTypeSafeguard;
 ...
 */
public class DapValue {

    /// False value constant
    public static final DapValue FalseValue = new DapValue(0);
    /// False value constant
    public static final DapValue TrueValue = new DapValue(1);
    /// null value constant
    public static final DapValue NullValue = new DapValue((Object)null);
     ...
     */
    private DapValue(Object value) {
        this.value = value;
    }

    public DapValue(DapValue[] values) {
        this.value = values;
    }
     ...
     */
    public DapValue add(DapValue right, ParserRuleContext context) {
        if (this.isAStringValue() && right.isAStringValue()) {
            return new DapValue(this.underlyingString() + right.underlyingString());
        }
        else if (this.isAStringValue() && right.isANumericalValue()) {
            return new DapValue(this.underlyingString() + IOFormatter.numericalOutputFormat.format(right.underlyingNumber()));
        }
        else if (this.isANumericalValue() && right.isAStringValue()) {
            return new DapValue(IOFormatter.numericalOutputFormat.format(this.underlyingNumber()) + right.underlyingString());
        }
        else {
     ...
     */
    public DapValue and(DapValue right, ParserRuleContext context) {
     ...
     */
    private DapValue arithmeticEvaluation(DapValue right, BiFunction<Double, Double, Double> operator, ParserRuleContext context) {
        ...
        return new DapValue(operator.apply(this.underlyingNumber(), right.underlyingNumber()));
    }
     ...
     */
    public DapValue divide(DapValue right, ParserRuleContext context) {
     ...
     */
    public DapValue equal(DapValue right, ParserRuleContext context) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DapValue)) {
            return false;
        }

        DapValue otherValue = (DapValue) obj;
     ...
     */
    public DapValue greaterThen(DapValue right, ParserRuleContext context) {
     ...
     */
    public DapValue greaterThenEqual(DapValue right, ParserRuleContext context) {
        return this.compare(right, (l, r) -> l >= r, context);
    }
    ...
    public boolean isAnOneDimensionalArrayValue() {
        return this.value instanceof DapValue[];
    }
     ...
     */
    public DapValue lessThen(DapValue right, ParserRuleContext context) {
        return this.compare(right, (l, r) -> l < r, context);
    }
     ...
     */
    public DapValue lessThenEqual(DapValue right, ParserRuleContext context) {
        return this.compare(right, (l, r) -> l <= r, context);
    }
     ...
     * @return This Value object instance divided by the divisor 'right'
     */
    public DapValue modulo(DapValue right, ParserRuleContext context) {
        return this.arithmeticEvaluation(right, (l, r) -> l % r, context);
    }
     ...
     */
    public DapValue multiply(DapValue right, ParserRuleContext context) {
        return this.arithmeticEvaluation(right, (l, r) -> l * r, context);
    }
     ...
     */
    public DapValue notEqual(DapValue right, ParserRuleContext context) {
        DapValue eq = this.equal(right, context);
     ...
     */
    private DapValue compare(DapValue right, BiFunction<Double, Double, Boolean> comparison, ParserRuleContext context) {
     ...
     */
    public DapValue negate(NegateExpressionContext context) {
        ValueTypeSafeguard.guaranteeValueIsNumerical("Only numerical values can be negated", this, context);
        return new DapValue(-this.underlyingNumber());
    }
     ...
     */
    public DapValue not(ParserRuleContext context) {
     ...
     */
    public DapValue or(DapValue right, ParserRuleContext context) {
        return this.isTruthy(context) || right.isTruthy(context) ? TrueValue : FalseValue;
    }
        ...
        if (this.isANumericalValue()) {
            ...
            if (this.isAnOneDimensionalArrayValue()){
                ...
                for (int i = 0; i < this.underlyingTwoDimensionalArray().length; i++) {
                    new DapValue(this.underlyingTwoDimensionalArray()[i]).printValue(printStream, false);
                    if (i > 0) {
                        outputBuilder = new StringBuilder(outputBuilder.toString().concat(", "));
                    }
                }
                ...
                for (int i = 0; i < this.underlyingThreeDimensionalArray().length; i++) {
                    ...
                    new DapValue(this.underlyingThreeDimensionalArray()[i]).printValue(printStream, false);
                }
            }
             outputBuilder = new StringBuilder(outputBuilder.toString().concat("} "));
        }
     ...
     */
    public DapValue subtract(DapValue right, ParserRuleContext context) {
        return this.arithmeticEvaluation(right, (l, r) -> l - r, context);
    }
     ...
     */
    public DapValue[] underlyingOneDimensionalArray() {
        return (DapValue[]) this.value;
    }
     ...
     */
    public DapValue[][] underlyingTwoDimensionalArray() {
        return (DapValue[][]) this.value;
    }
     ...
     */
    public DapValue[][][] underlyingThreeDimensionalArray() {
        return (DapValue[][][]) this.value;
    }
