...
public class ValueTypeSafeguard {
     ...
     */
    public static void guaranteeValueIsArray(String message, DapValue value, ParserRuleContext context) throws TypeException {
     ...
     * @param context The parsing context where the value was used
     */
    public static void guaranteeValueIsNumerical(String message, DapValue value, ParserRuleContext context) throws TypeException {
     ...
     * @param context The parsing context where the value was used
     */
    public static void guaranteeValueIsString(String message, DapValue value, ParserRuleContext context) throws TypeException {
