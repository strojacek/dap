...
import com.dap.interpreter.DapInterpreter;
...
public class DapCLI {
        ...
        public static void main(String[] args) {
            ...
            if (args.length != 1) {
                System.out.println("Usage: Dap <script>");
                System.exit(64);
            }
        ...
        private static void runScript(String path) {
            ...
            DapInterpreter interpreter = null;
            try {
                // Open file under specified path
                inputStream = new FileInputStream(path);
                // Creates a new DapInterpreter object instance using the standard input, output and error output stream
                interpreter = new DapInterpreter(System.in, System.out, System.err);
        ...
        private static void showVersion() {
            System.out.println(DapCLI.class.getPackage().getImplementationTitle() +
                    " Version: " + DapCLI.class.getPackage().getImplementationVersion());
        }
        ...
        private static void showHelp() {
            System.out.println(DapCLI.class.getPackage().getImplementationTitle() +
                    " Help:\n" +
                    "Usage: Dap (-h|--help|-v|--version|<script>)\n\n" +
                    "Options\n" +
